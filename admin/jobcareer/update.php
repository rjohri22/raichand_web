                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class="row">
                                ...
                                <div class="d-flex">
                                    <!-- ======================= form ============================ -->
                                    <form method="GET" action="updateprocess.php" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="col-md-12 border-bottom p-0">
                                            <textarea name="responsibilities"><?php echo $row['responsibilities']; ?></textarea>   
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea name="eligibility_criteria"><?php echo $row['eligibility_criteria']; ?></textarea>    
                                        ...
                                        <div class="form-group mb-4">
                                            <div class="col-sm-12">
                                                <input type="submit" class="btn btn-success" name="submit" id="submit" value="Update">
                                                 <!-- Modify 24/8/2022 start -->
                                                    <a href="/admin/jobcareer/jobindex.php"><button type="button" class="btn btn-outline-success">Cancel</button></a>
                                                <!-- Modify 24/8/2022 end -->
                                            </div>
                                        </div>
