...
<head>
    ...
    $name = $uriSegments[2]; //returns foo 
    $filename = $uriSegments[3]; //returns foo 
    ...
    // echo $name; exit;
    if ($name == 'policies' AND $filename == 'cindex.php') {
        $name = 'Our Businesses';
    } 
    elseif($name == 'press-release'){
        $name = 'press-release';
    }
    elseif($name == 'policies'){
        $name = 'Policies';
    }
    elseif($name == 'invester'){
        $name = 'Invester';
    }
    else{
        $name = $name;
    ...
    ?>
    <!-- <title>TRG Portal</title>RAICHAND - TRG Admin - FAQ -->
    <title>RAICHAND - TRG Admin - <?php echo ucfirst($name);?></title>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item pt-2">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="./../policies/cindex.php" aria-expanded="false">
                                <i class="fas fa-briefcase" aria-hidden="true"></i>
                                <span class="hide-menu">Our Businesses</span>
                            </a>
                        </li>
                        <li class="sidebar-item pt-2">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="../periods/" aria-expanded="false">
