                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-3 col-md-12">
                            <div class="white-box analytics-info">
                                <a href="/admin/policies/cindex.php">
                                    <div class="card">
                        ...
                        <div class="col-lg-3 col-md-12">
                            <div class="white-box analytics-info">
                                <a href="/admin/periods/index.php">
                                    <div class="card">
                                        <div class="card-body bg-warning">
                                            <h3>Periods</h3>
                                            <img src="https://cdn2.iconfinder.com/data/icons/bubble-seo-internet-marketing-3/360/Press_Release-512.png" />
...
<style>#main-wrapper[data-layout=vertical][data-sidebartype=full] .page-wrapper {
