                        ...
                        <table class="table text-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-top-0">Is Active/Inactive</th>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                        <td>
                                        <a class="btn btn-info" onclick="//return confirm('are you sure you wont to update?')" href="update.php?id=<?php echo $row['id']; ?>"><i class="fa fa-edit" style="color: #fff;"></a>
