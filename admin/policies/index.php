                ...
                <div class="white-box">
                    <div class="row">
                        ...
                        <div class="col-md-12" align="right">
                            ...
                            <a href="policies.php"><button type="button" class="btn btn-primary btn-sm">ADD POLICY</button></a>
                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap">
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-info" href="edit.php?id=<?php echo $row['id']; ?>"><i class="fa fa-edit" style="color: #fff;"></a>
                                <a class="btn btn-danger" onclick="setdltAlert('delete.php?id=<?php echo $row['id']; ?>')"><i class="fa fa-trash" style="color: #fff;"></a></td></tr>
