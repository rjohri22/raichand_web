                ...
                <div class="white-box">
                    <div class="row">
                        ...
                        <div class="col-md-12" align="right">
                            <a href="policies_add_cat.php"><button type="button" class="btn btn-warning text-white">ADD CATEGORY</button></a>
                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn" href="policies_edit_cat.php?id=<?php echo $row['id']; ?>"><img src="https://cdn.pixabay.com/photo/2017/06/06/00/33/edit-icon-2375785_1280.png" style="height:40px;width:40px"/></a>
                                    <a class="btn" onclick="setdltAlert('policies_delete_cat.php?id=<?php echo $row['id']; ?>')"><img src="https://cdn.icon-icons.com/icons2/1808/PNG/512/trash-can_115312.png" style="height:40px;width:40px"/></i></a>
