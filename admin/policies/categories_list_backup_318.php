                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap">
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-info" href="policies_edit_cat.php?id=<?php echo $row['id']; ?>"><i class="fa fa-edit" style="color: #fff;"></a>
                                <a class="btn btn-danger" onclick="return confirm('are you sure?')"  href="policies_delete_cat.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash" style="color: #fff;"></a></td></tr>
                            <?php
