                        ...
                        <form class="form-horizontal form-material" method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
                            <div class="form-group mb-4">
                                ...
                                <br>
                                  ...
                                  <p class="text-secondary">Your Url will Be like this: <?php echo SITEURL;?>portal/investors-relation/<span id='period'>Period</span>/<span id='url'>invester_Title</span></p>                                                       
                            </div>
                            <div class="form-group mb-4">
