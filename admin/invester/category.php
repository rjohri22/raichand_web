...

 {
    ...
    if ($row) {
        ...
        echo "<script>$(document).ready(function(){
            setSuccessAlert('" . SITE_URL . "admin/invester/cindex.php','Good job!','Data submitted successfully'); 
        });</script>";
        
    } else {
        echo "<script>$(document).ready(function(){
            setSuccessAlert('" . SITE_URL . "admin/invester/cindex.php','Good job!','Sorry Data Not submitted'); 
        });</script>";
    }
