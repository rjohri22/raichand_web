                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material" method="POST" enctype="multipart/form-data">
                            <div class="form-group mb-4">
                                ...
                                <p class="text-secondary">Your Url will Be like this: <?php echo SITEURL;?>portal/investors-relation/<span id='period'>Period</span>/<span id='url'><?php echo $rm['slug']; ?></span></p>                                                       
                            </div>
                            <div class="form-group mb-4">
