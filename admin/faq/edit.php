...
if (isset($_POST['submit']))
 {
    ...
    if ($row) {
        ...
        echo "<script>$(document).ready(function(){
            setSuccessAlert('" . SITE_URL . "admin/faq/','Good job!','Data Updated successfully'); 
        });</script>";
        
    } else {
        echo "<script>$(document).ready(function(){
            setSuccessAlert('" . SITE_URL . "admin/faq/','Good job!','Sorry Data Not Updated'); 
        });</script>";
    }
        // if ($row)
        //  {
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal form-material" method="POST">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="col-md-12 border-bottom p-0 border-0">
                                    <select name="tag" class="form-control p-0 border-0">
                                        ...
                                        <option value="Vendors" <?php if ($rm['tag']=="Suppliers") echo "selected";?>>Vendors </option>
                            ...
                            <div class="form-group mb-4">
                                <label for="title"> Order No:</label><br>
                                <div class="col-md-12 border-bottom p-0">
                            ...
                            <div class="form-group mb-4">
                                <div class="col-sm-12">
                                    ...
                                    <a href="/admin/faq/"><button type="button" class="btn btn-outline-success">Cancel</button></a>
