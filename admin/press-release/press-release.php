...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO press_release (file_name,file_size,file_type,year,category_id,tags,slug) VALUES ('$file_name',$size,'$ext','$year'
        ,'$category','$tags','$slug')";
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material" method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="col-md-12 border-bottom p-0">
                                    <input class="form-control form-control-sm p-0 border-0" name="uploadfile" id="formFileSm" type="file" class="form-control p-0 border-0" accept=".xlsx,.doc,.ppt,.pdf,.zip,.xls,.docx" required>
                                </div><br>
                                <div class="text-secondary"><i>Allowed document(.xlsx,.doc,.ppt,.pdf,.zip,.xls,.docx).</i></div>
