...
// echo "<pre>";print_r($_POST);exit;
{
    ...
    $existing_filetype = $_POST["existing_filetype"];
        ...
        $sql = "UPDATE `press_release` SET `file_name` ='$file_name', `file_size` = '$size', `file_type` = '$ext', `year` = '$year',  `category_id`='$category', `tags` = '$tags' WHERE  id='" . $newid . "'";
        }
        else{
            
            $sql = "UPDATE `press_release` SET `file_name` ='$file_name', `file_size` = '$existing_filesize', `file_type` = '$existing_filetype', `year` = '$year',  `category_id`='$category', `tags` = '$tags' WHERE  id='" . $newid . "'";
