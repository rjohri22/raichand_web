...

 {
    ...
    if ($row) {
        ...
        echo "<script>$(document).ready(function(){
            setSuccessAlert('" . SITE_URL . "admin/press-release/cindex.php','Good job!','Data submitted successfully'); 
        });</script>";
        
    } else {
        echo "<script>$(document).ready(function(){
            setSuccessAlert('" . SITE_URL . "admin/press-release/cindex.php','Good job!','Sorry Data Not submitted'); 
        });</script>";
    }


?>
    <!-- <script>window.location.href="<?php //echo SITE_URL;?>admin/press-release/cindex.php"; </script> -->
<?php	
