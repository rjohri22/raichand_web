                        ...
                        <table class="table text-nowrap">
                            ...
                            <?php if (mysqli_num_rows($result)>0)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-info" onclick="return" href="Edit_category.php?id=<?php echo $row['id']; ?>">Edit</a>    
                                        <a class="btn btn-danger" onclick="return confirm('are you sure?')" href="delete_category.php?id=<?php echo $row['id']; ?>">Delete</a></td>
                                    </td>
                                <?php 
                            }
                            }
