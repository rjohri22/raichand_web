...
// $insert = "SELECT * FROM press_release ORDER BY id DESC " ;
                ...
                <div class="white-box">
                    <div class="row">
                        ...
                        <div class="col-md-12" align="right">
                            ...
                            <a href="press-release.php"><button type="button" class="btn btn-warning text-white">ADD</button></a>
                                ...
                                <tr>
                                    ...
                                    <td><?php //echo $row['file_size']; ?>
                                     ...
                                     <!-- Modify 24/8/2022 end -->
                                        ...
                                        <td><?php 
                                            $sql1 = "SELECT * FROM `press_category` ORDER BY id DESC ";
                                            $result1 = mysqli_query($con, $sql1);
                                            while ($row1 = mysqli_fetch_assoc($result1)) {
                                        ...
                                        <a class="btn" onclick="setdltAlert('delete.php?deleteid=<?php echo $row['id'];?>')"><img src="https://cdn.icon-icons.com/icons2/1808/PNG/512/trash-can_115312.png" style="height:40px;width:40px"/></a></td>
