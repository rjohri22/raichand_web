                            ...
                            if (mysqli_num_rows($result)>0)
                                ...
                                <tr>
                                    ...
                                    <td><?php //echo $row['file_size']; ?>
                                        ...
                                        <td><a class="btn btn-info btn-sm" href="edit.php?id=<?php echo $row['id'];?>"><i class="fa fa-edit" style="color: #fff;"></i></a>
                                        <a class="btn btn-danger btn-sm" onclick="return confirm('are you sure !')" href="delete.php?deleteid=<?php echo $row['id'];?>"><i class="fa fa-trash" style="color: #fff;"></i></a></td>
                                </tr>
                                <?php 
                                }
                            }
