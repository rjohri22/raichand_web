...
<!-- <script src="intl-tel-input-master/build/js/intlTelInput-jquery.min.js"></script>   -->
    ...
    function sendid() {
        ...
        $.ajax({
            ...
            success: function(data) { 
                //console.log(data);
                $("#sp_email_newsletter_subscription").html("Now you are subscribed!");
                $('#newsletter_emails').val('');
...
<!-- <script>
                $(document).ready(function() {
                    ...
                    $('#stdtable').DataTable({
                        ...
                        // 'serverSide': true,
                        // 'serverMethod': 'POST',
                        'ajax': 'http://localhost/php/ajax/Task/newajaxdatatable.php',
